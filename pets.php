...
<body>
    ...
    <div class="container-s" id="3-s">
        ...
        <h2>Munchkin Cat</h2>
        <hr>
        <p>The Munchkin cat is a new breed known for its very short legs, resulting from a genetic mutation. Munchkins are a small-medium breed weighing between 2 and 4 kg and standing around 18 –20 cm tall. Their lifespan is around 12 – 14 years.</p>
    </div>  
    ...
    <script>
        ...
        $('.1-l').click(function(){
            $('#1-l').show();
            $('#2-l, #3-l, #4-l, #1-s, #2-s, #3-s, #4-s, #5-s').hide();
        });
        $('.2-l').click(function(){
            $('#2-l').show();
            $('#1-l, #3-l, #4-l, #1-s, #2-s, #3-s, #4-s, #5-s').hide();
        });
        $('.3-l').click(function(){
            $('#3-l').show();
            $('#1-l, #2-l, #4-l, #1-s, #2-s, #3-s, #4-s, #5-s').hide();
        });
        $('.4-l').click(function(){
            $('#4-l').show();
            $(' #1-l, #2-l, #3-l, #1-s, #2-s, #3-s, #4-s, #5-s').hide();
        });
        $('.1-s').click(function(){
            $('#1-s').show();
            $('#1-l, #2-l, #3-l, #4-l, #2-s, #3-s, #4-s, #5-s').hide();
        });
        $('.2-s').click(function(){
            $('#2-s').show();
            $('#1-l, #2-l, #3-l, #4-l, #1-s, #3-s, #4-s, #5-s').hide();
        });
        $('.3-s').click(function(){
            $('#3-s').show();
            $('#1-l, #2-l, #3-l, #4-l, #1-s, #2-s, #4-s, #5-s').hide();
        });
        $('.4-s').click(function(){
            $('#4-s').show();
            $('#1-l, #2-l, #3-l, #4-l, #1-s, #2-s, #3-s, #5-s').hide();
        });
        $('.5-s').click(function(){
            $('#5-s').show();
            $('#1-l, #2-l, #3-l, #4-l, #1-s, #2-s, #3-s, #4-s').hide();
        });
